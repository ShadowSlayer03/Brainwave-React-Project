            ...
            <div className='relative'>
                ...
                border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                    <div className='absolute top-0 left-0 h-full w-full pointer-events-none md:w-3/5 xl:w-auto'>
                        <img className='h-full w-full object-cover md:object-right'
                ...
                <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    rounded-3xl overflow-hidden'>
                        ...
                        from-n-8/0 to-n-8/90 lg:p-15'>
                            ...
                            using our AI app&apos;s photo editing feature.
                            Try It Now!
                            </p>
                        </div>
                    ...
                    lg:min-h-[46rem]'>
                        <div className='py-12 px-4 xl:px-8 '>
                            ...
                            <p className='body-2 mb-[2rem] text-n-3'>
                                The most powerful AI photo and Video Art Generation
                                engine is right at your fingertips. What will you create?
                            </p>
                            ...
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item,index)=>(
                                    ...
                                    ${index===2? "w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]": "flex w-10 h-10 bg-n-6 md:w-15 md:h-15"}`}>
                                        <div className={index===2? `flex items-center justify-center
                                        w-full h-full bg-n-7 rounded-[1rem]`: ``}>
                                            <img src={item} width={24} height={24} alt="Service Icon" />
                                        </div>
                                    </li>
                                ))}
                            </ul>
