  ...
  return (
    ...
    <div className='container relative' ref={parallaxRef}>
        ...
        mb-[4rem] md:mb-20 lg:mb-[6rem]'>
            <h1 className='h1 mb-6'>Explore the Possibilities of AI with&nbsp;
            ...
            <p className='body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8'>
                Unleash the power of AI within Brainwave. <br />
                Upgrade your productivity with our all new AI Chat App. 
            </p>
        ...
        <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
            ...
            md:-top-[46%] md:w-[138%] lg:-top-[104%]'>
                <img src={heroBackground} className='w-full' 
                 alt="robot" width={1440} height={1800} />
            </div>
            <BackgroundCircles />
        </div>
